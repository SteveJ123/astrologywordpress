...
function twentynineteen_scripts() {
	...
	// echo "scripts";
	wp_enqueue_style('fontawesome', '//cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/css/all.css');
	wp_enqueue_style('merriweather', '//fonts.googleapis.com/css?family=Merriweather&display=swap');


	wp_enqueue_script( 'bootstrap-script', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '2.1.1', true );
	wp_enqueue_style( 'bootstrap-style', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '4.0.0', 'all' );
	

	wp_enqueue_script( 'script', get_template_directory_uri() . '/js/astrology.js', array ( 'jquery' ), "", true);
	wp_enqueue_style( 'insurancecss', get_template_directory_uri() . '/css/astrology.css', array(), '4.0.0', 'all' );
